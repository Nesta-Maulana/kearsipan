...
?>
<div class="row">
	<form method="post" action="<?=baseurl('sekretaris/sekretaris-aksi/'.base64_encode('input-detail-disposisi'))?>">
			...
			<div class="card">
				<div class="card-content">
					...
					<div class="row">
						...
						<?php if (!empty($edit)) 
						{ ?>
						<a href="<?=baseurl('sekretaris/lihat-surat/'.base64_encode($surat->id_surat))?>" name="kembali" class="waves-effect waves-light btn blue darken-2 right">Kembali</a>
					<?php }else{ ?>
						<a href="<?=baseurl('sekretaris/sekretaris-aksi/'.base64_encode('batal-disposisi').'/'.base64_encode($surat->id_surat))?>" name="kembali" class="waves-effect waves-light btn blue darken-2 right">Kembali</a>
						<?php } ?>
					</div>
