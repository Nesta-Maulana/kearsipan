					...
					<div class="col l6">
						<div class="card">
							<div class="card-content">
								...
								<div class="input-field">
									<input type="submit" name="simpan" value="Kembali Ke Beranda" class="btn waves-effect waves-ligth deep-purple darken-4" onclick="document.location.href='<?=baseurl('sekretaris/index')?>'">
							...
							while ($surat = mysql_fetch_object($jalan)) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?=baseurl('sekretaris/sekretaris-aksi/'.base64_encode('hapus-surat').'/'.base64_encode($surat->id))?>">Hapus</a>
										</td>
									</tr>
					<?php	}
