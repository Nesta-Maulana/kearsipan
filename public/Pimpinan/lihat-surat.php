			...
			<div class="card-content ">
				<div class="row">
					<div class="col l12 right">
						<a href="<?=baseurl('pimpinan/arsip-perusahaan')?>">
						...
						<?php if ($isi_surat->jenis_surat == 'Surat Masuk'): ?>
								<a class="btn deep-purple darken-4" href="<?=baseurl('pimpinan/pimpinan-aksi/'.base64_encode('input-head-disposisi').'/'.base64_encode($isi_surat->idnya))?>">
									Disposisikan
								</a>
						<?php endif ?>
					</div>
