						...
						<div class="card">
							<div class="card-content">
								<div class="card-title">Filter Tanggal
									<div class="right">
										<input type="submit" name="kembali"	value="Kembali" onclick="document.location.href='<?=baseurl('pimpinan/index')?>'" class="btn deep-purple darken-4">
									</div>
								</div>
								<div class="row">		
									<div class="col l12">
										<form method="post" action="<?=baseurl('pimpinan/pimpinan-aksi/'.base64_encode('filter-tampil'))?>">
											<table>
												<tr>
													<td>
					...
					<div class="col l12">
						...
						{ ?>
						 	<tr>
						 		...
						 		<td><a href="<?=baseurl('pimpinan/lihat-surat/'.base64_encode($data->surat_kode))?>">Lihat</a></td>
						 	</tr>
