 <?php
	...
	if (empty($_SESSION[sha1('pimpinan')])) 
	{
	...
	else
	{
		...
		$_SESSION[sha1('login')]	= '';
		$username 			= base64_decode($_SESSION[sha1('pimpinan')]);
        	...
        	<ul class="collapsible collapsible-accordion">
	          	<li>
	        		...
	        		<div class="collapsible-body">
	              		<ul>
	                		<li><a href="<?=baseurl('pimpinan/surat-masuk')?>">Surat Masuk</a></li>
	                		<li><a href="<?=baseurl('pimpinan/surat-keluar')?>">Surat Keluar</a></li>
	                		<li><a href="<?=baseurl('pimpinan/arsip-perusahaan')?>">Arsip Perusahaan</a></li>
	              		</ul>
	            	</div>
	          </li>
        	</ul>
	...
	<nav style="background-color: #001F24;">
		<ul class="hide-on-med-and-down">
			...
			<li style="font-family: 'Times New Roman',sans-serif;">
				<a href="<?=baseurl('pimpinan/index')?>" class="brand-logo">KEARSIPAN</a>
			</li>
		</ul>
				...
				<li class="dropdown-button" data-activates="notifikasi" id="notif" style="padding-right: 10px;">
					...
					<ul class="dropdown-content" id="notifikasi"  style="min-width: 450px;margin-top: 70px">
						...
						<div class="card-action center ">
							<a href="<?=baseurl('pimpinan/notifikasi')?>" class="black-text">Lihat Semua</a>	
						</div>
					</ul>
				</li>
