						...
						<div class="col l6">
							<div class="card">
								<div class="card-content">
									...
									<div class="input-field">
										<input type="submit" name="simpan" value="Kembali Ke Beranda" class="btn waves-light deep-purple darken-4" onclick="document.location.href='<?=baseurl('administrator/index')?>'">
