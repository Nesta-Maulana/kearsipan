			...
			<div class="card-content ">
				<div class="row">
					<div class="col l12 right">
						<a href="<?=baseurl('administrator/arsip-perusahaan')?>">
						...
						<?php if ($isi_surat->jenis_surat == 'Surat Masuk'): ?>
								<a class="btn deep-purple darken-4" href="<?=baseurl('administrator/administrator-aksi/'.base64_encode('input-head-disposisi').'/'.base64_encode($isi_surat->idnya))?>">
									Disposisikan
								</a>
						<?php endif ?>
					</div>
		...
		<div class="col l10 offset-l1">
			<div class="card">
				...
				<div class="card-title">
					...
					<a class="btn deep-purple darken-4 right" href="<?=baseurl('print-disposisi/'.base64_encode($isi_surat->idnya))?>">
